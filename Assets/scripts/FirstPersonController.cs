...
namespace StarterAssets
{
    ...
    public class FirstPersonController : NetworkBehaviour
    {
        ...
        [SerializeField] private float walkForwardOffset = 0.2f;
        [SerializeField] private float runForwardOffset = 0.5f;
        ...
        private void Move()
        {
            Vector3 targetPosition = originalCameraLocalPosition;

            switch (_speed)
            {
                case >= 6:
                    targetPosition += Vector3.forward * runForwardOffset;
                    break;
                case >= 4:
                    targetPosition += Vector3.forward * walkForwardOffset;
                    break;
                default:
                    // Duruyorsa orijinal pozisyona dön
                    break;
            }

            // Pozisyonu yumuşak şekilde geçiş yap
